 ...
 * @route '/livewire-b4046856/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-b4046856/livewire.js',
 ...
 * @route '/livewire-b4046856/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-b4046856/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-b4046856/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-b4046856/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
