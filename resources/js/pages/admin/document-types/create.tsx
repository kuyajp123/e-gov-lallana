...
export default function DocumentTypeCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        form_schema: [] as FormSchemaField[],
        is_active: true,
    });
    ...
    return (
        <>
            <Head title="Create Document Type | Admin Console" />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Define a new barangay document, standard fees,
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="space-y-1.5">
                                    ...
                                    <p className="text-[11px] text-muted-foreground">
                                        Enter 0.00 for free services (e.g.
                                        Indigency). Stored internally as{' '}
                                        {data.fee_cents} centavos.
                                    </p>
                                    {errors.fee_cents && (
                                        <p className="text-[11px] text-destructive">
                                            {errors.fee_cents}
                            ...
                            <div className="space-y-2 border-t border-border/70 pt-2">
                                ...
                                <p className="text-[11px] text-muted-foreground">
                                    ...
                                    claiming or attach during online application
                                    (e.g., Valid ID, 2x2 Picture, Cedula).
                                </p>

                                <div className="flex items-center gap-2">
                                    <Input
                                        placeholder="Add required document (e.g., Government Issued ID)..."
