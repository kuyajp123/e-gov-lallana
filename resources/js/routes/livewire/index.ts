 ...
 * @route '/livewire-b4046856/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-b4046856/upload-file',
 ...
 * @route '/livewire-b4046856/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-b4046856/preview-file/{filename}',
