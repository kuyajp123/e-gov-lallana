...
/**
* @see \App\Http\Controllers\Admin\AdminAnnouncementController::toggle
 * @see app/Http/Controllers/Admin/AdminAnnouncementController.php:259
 * @route '/admin/announcements/{announcement}/toggle'
 */
export const toggle = (args: { announcement: number | { id: number } } | [announcement: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/admin/announcements/{announcement}/toggle'
 */
toggle.patch = (args: { announcement: number | { id: number } } | [announcement: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggle.url(args, options),
    method: 'patch',
})
 ...
 * @route '/admin/announcements/{announcement}/toggle'
 */
    const toggleForm = (args: { announcement: number | { id: number } } | [announcement: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/announcements/{announcement}/toggle'
 */
        toggleForm.patch = (args: { announcement: number | { id: number } } | [announcement: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: toggle.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
