...
/**
* @see \App\Http\Controllers\Admin\AdminDocumentTypeController::toggle
 * @see app/Http/Controllers/Admin/AdminDocumentTypeController.php:163
 * @route '/admin/document-types/{documentType}/toggle'
 */
export const toggle = (args: { documentType: number | { id: number } } | [documentType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/document-types/{documentType}/toggle'
 */
toggle.url = (args: { documentType: number | { id: number } } | [documentType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { documentType: args }
    }
 ...
 * @route '/admin/document-types/{documentType}/toggle'
 */
toggle.post = (args: { documentType: number | { id: number } } | [documentType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggle.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/document-types/{documentType}/toggle'
 */
    const toggleForm = (args: { documentType: number | { id: number } } | [documentType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/document-types/{documentType}/toggle'
 */
        toggleForm.post = (args: { documentType: number | { id: number } } | [documentType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: toggle.url(args, options),
            method: 'post',
        })
